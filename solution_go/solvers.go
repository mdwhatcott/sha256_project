...
import "github.com/mdwhatcott/sha256_project/solution_go/sha256"
...
func (p *Problems) SolveProblem5(s *Solutions) {
	s.Problem5 = sha256.MessageSchedule(p.Problem5)
}
...
func (p *Problems) SolveProblem11(s *Solutions) {
	s.Problem11 = sha256.Compress(p.Problem11.State, p.Problem11.Block)
}
